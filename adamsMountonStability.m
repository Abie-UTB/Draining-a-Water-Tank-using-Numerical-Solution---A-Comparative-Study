...
% hold on;
% contour(x, y, abs(FE_stability), [0, 1], 'LineColor', 'b'); % Add outlines for unstable region
% xlabel('Re(z)');
% ylabel('Im(z)');
...
hold on;
contour(x, y, abs(BE_stability), [0, 1], 'LineColor', 'b'); % Add outlines for unstable region
xlabel('Re(z)');
ylabel('Im(z)');
